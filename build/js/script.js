...
$('.animate-heading').attr({
  'data-aos': 'animate__fadeInDown'
});

var animation_on_scroll = _aos.default.init({
  useClassNames: true,
  initClassName: false,
...
var swiper_arguments = new _swiperBundle.default('.main-arguments .swiper', {
  loop: true,
  slidesPerView: 'auto',
  mousewheel: true,
  breakpoints: {
...
var swiper_automation = new _swiperBundle.default('#automation .swiper', {
  breakpoints: {
    992: {
      loop: false,
      grid: {
...
var swiper_joinUs = new _swiperBundle.default('#join-us .swiper', {
  slidesPerView: 'auto',
  loop: true,
  spaceBetween: 30,
  mousewheel: true,
...
var swiper_blog = new _swiperBundle.default('.news.swiper', {
  loop: true,
  slidesPerView: 1,
  spaceBetween: 15,
  on: {
...
var swiper_fs_fresh = new _swiperBundle.default('.fresh .swiper', {
  spaceBetween: 20,
  slidesPerView: 'auto',
  on: {
    init: function init() {
...
var swiper_fresh_include = new _swiperBundle.default('#what-include .swiper', {
  loop: true,
  slidesPerView: 'auto',
  mousewheel: true,
...
var swiper_why_introduction = new _swiperBundle.default('.why-introduction .swiper', {
  spaceBetween: 10,
  breakpoints: {
    320: {
      loop: true,
...
var swiper_useful = new _swiperBundle.default('.useful-slider', {
  spaceBetween: 15,
  slidesPerView: "auto",
  loop: true,
  slidesOffsetBefore: 10,
...
var swiper_its = new _swiperBundle.default('#what-include-its .swiper', {
  spaceBetween: 20,
  slidesPerView: "auto",
  loop: true,
  slidesOffsetBefore: 10,
...
var swiper_its_stages = new _swiperBundle.default('.stages-its .swiper', {
  spaceBetween: 15,
  slidesPerView: "auto",
  loop: true,
  slidesOffsetBefore: 10,
...
var service_list_items = $('#page-services .services-list > li');

if (service_list_items.length > 0) {
  if (document.body.clientWidth > 992) {
    var service_active_HTML = document.querySelector('#page-services .services-list > li.active .service-descript').outerHTML;
    ...
    service_list_items.click(function () {
      ...
      var activeHtml = document.querySelector('#page-services .services-list > li.active .service-descript').outerHTML;
...
var swiper_services_partners = new _swiperBundle.default('.services-partners .swiper', {
  slidesPerView: "auto",
  slidesOffsetBefore: 15,
  loop: true,
  mousewheel: true,
...
var blog_news_categories = new _swiperBundle.default('.page-blog .news-categories .swiper', {
  slidesPerView: "auto",
  breakpoints: {
    320: {
      spaceBetween: 10,
...
var swiper_about_fs = new _swiperBundle.default('.first-screen.about .swiper', {
  slidesPerView: 'auto',
  mousewheel: true,
  on: {
    click: function click() {
...
var tabs = document.querySelector('#automation .tabs');
var tablinks = Array.from(document.querySelectorAll('#automation .tablinks'));
var helpContainers = Array.from(document.querySelectorAll('.help-container'));
...
if (tabs && tablinks.length > 0) {
  tabs.addEventListener('click', function (e) {
    ...
    if (target.classList.contains('tablinks')) {
      tablinks.forEach(function (elem, i) {
        elem.classList.remove('active');
      });
      target.classList.add('active');
      var tabData = $(target).data('tab');
      $(helpContainers).removeClass('active animate__animated animate__fadeIn');
      $("#".concat(tabData)).addClass('active animate__animated animate__fadeIn');
    }
  });
}

var crm_bonus_tabs = $('.bonus__crm .bonus-tabs');
var crm_bonus_tablinks = $('.bonus__crm .tablinks');
var crm_bonus_content_lists = $('.bonus-list');
...
if (crm_bonus_tabs && crm_bonus_tablinks.length > 0) {
  crm_bonus_tabs.click(function (e) {
    ...
    if (target.hasClass('tablinks')) {
      crm_bonus_tablinks.each(function (i, elem) {
        $(elem).removeClass('active');
      });
      $(target).addClass('active');
      var tabData = $(target).data('tab_bonus');
...
var towns_tabs = $('.towns-tabs');
var towns_tabs_tablinks = $('.towns-tabs .tablinks');
var contacts_content = $('.contacts__content .contacts-box');
...
if (towns_tabs && towns_tabs_tablinks.length > 0) {
  towns_tabs.click(function (e) {
    ...
    if (target.hasClass('tablinks')) {
      towns_tabs_tablinks.each(function (i, elem) {
        $(elem).removeClass('active');
      });
      $(target).addClass('active');
      var tabData = $(target).data('tab_town');
...
$('.pane-title').click(function (e) {
  $(this).toggleClass('active').closest('.pane').toggleClass('active').find('.pane-content').slideToggle();
}); //-------- МЕНЮ --------//
...
if (typeof ymaps !== 'undefined') {
  var init = function init() {
    ...
    var placemark = new ymaps.Placemark([59.932076155000516, 30.421123439659908], {}, {
...
},{"aos":1,"micromodal":2,"swiper/swiper-bundle":3}]},{},[4]);
